  ...
  return await withTransaction(async (c) => {
    ...
    for (const b of BOARDS) {
      ...
      for (let i = 0; i < b.tasks.length; i++) {
        ...
        await c.query(
          `INSERT INTO tasks (
             ...
             due_date, assignee_id, position, created_by, created_at, updated_at
           )
      ...
      const acts = [
        ...
        {
          action: "task.moved",
          message: `${USERS.find((u) => u.key === (b.members[1] || b.owner))?.name || ownerName} moved "${b.tasks[Math.min(3, b.tasks.length - 1)]}"`,
        },
      ];
